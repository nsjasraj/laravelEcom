            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="../back2_assets/images/logo.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" type="email" placeholder="email" name="email" aria-label="Email" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
